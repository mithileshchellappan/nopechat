export default {
	...
	users: [{
		...
		id: 'u2',
		name: 'Lukas',
		imageUri: 'https://images.unsplash.com/photo-1601412436967-8b2d90944ded?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=80',
	}],
	messages: [{
		id: 'm1',
